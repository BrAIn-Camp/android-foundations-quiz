  ...
  return (
    <div className={`explanation-panel ${isCorrect ? 'explanation-correct' : 'explanation-wrong'}`}>
      ...
      <div className="explanation-section">
        <h4 className="explanation-section-title">Relationship, step by step</h4>
      ...
      <div className="tip-box">
        <span className="tip-label">💡 Big Picture</span>
        <p dangerouslySetInnerHTML={{ __html: formatInlineCode(explanation.tip) }} />
      </div>
    </div>
  );
}
